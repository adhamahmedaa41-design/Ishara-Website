    ...
    en: {
      ...
      story: {
        ...
        paragraphs: [
          ...
          'Founded in 2026 by a team of engineers, designers, and accessibility advocates, we set out to create wearable technology that truly makes a difference in people\'s lives.',
    ...
    ar: {
      ...
      story: {
        ...
        paragraphs: [
          ...
          'تأسست في عام 2026 من قبل فريق من المهندسين والمصممين ودعاة إمكانية الوصول، وانطلقنا لإنشاء تقنية يمكن ارتداؤها تحدث فرقًا حقيقيًا في حياة الناس.',
