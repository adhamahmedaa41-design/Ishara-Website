...
const FALLBACK_CATALOG: Record<string, Product> = {
  'smart-assistive-glasses': {
    ...
    images: [
      { src: '/products/glasses-1.jpg', alt: { en: 'Smart Glasses front', ar: 'النظارات — أمامي' } },
      { src: '/products/glasses-2.jpg', alt: { en: 'Smart Glasses 3/4', ar: 'النظارات — ثلاثة أرباع' } },
      { src: '/products/glasses-3.jpg', alt: { en: 'Smart Glasses side', ar: 'النظارات — جانبي' } },
      { src: '/products/glasses-4.jpg', alt: { en: 'Smart Glasses top', ar: 'النظارات — علوي' } },
  ...
  'smart-bracelet': {
    ...
    images: [
      { src: '/products/bracelet-1.jpg', alt: { en: 'Smart Bracelet front', ar: 'السوار — أمامي' } },
      { src: '/products/bracelet-2.jpg', alt: { en: 'Smart Bracelet 3/4', ar: 'السوار — ثلاثة أرباع' } },
      { src: '/products/bracelet-3.jpg', alt: { en: 'Smart Bracelet side', ar: 'السوار — جانبي' } },
      { src: '/products/bracelet-4.jpg', alt: { en: 'Smart Bracelet top', ar: 'السوار — علوي' } },
  ...
  'ishara-mobile-app': {
    ...
    images: [
      { src: '/products/app-1.jpg', alt: { en: 'Ishara app — translation', ar: 'التطبيق — الترجمة' } },
      { src: '/products/app-2.jpg', alt: { en: 'Ishara app — voice to text', ar: 'التطبيق — صوت إلى نص' } },
      { src: '/products/app-3.jpg', alt: { en: 'Ishara app — learning hub', ar: 'التطبيق — مركز التعلم' } },
      { src: '/products/app-4.jpg', alt: { en: 'Ishara app — emergency signs', ar: 'التطبيق — إشارات الطوارئ' } },
      { src: '/products/app-5.jpg', alt: { en: 'Ishara app — sign and speech', ar: 'التطبيق — إشارة وكلام' } },
      { src: '/products/app-6.jpg', alt: { en: 'Ishara app lifestyle', ar: 'التطبيق — استخدام يومي' } },
    ],
...
export default function ProductDetailPage() {
  ...
  const galleryImages = (product.images || [])
    ...
    .map((img) => ({ ...img, src: resolveImageUrl(img.src) }));
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            {galleryImages.length > 0 ? (
              ...
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-card to-muted flex items-center justify-center border border-border overflow-hidden">
