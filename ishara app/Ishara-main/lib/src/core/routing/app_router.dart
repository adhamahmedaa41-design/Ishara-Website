...
import '../../features/translator/presentation/sign_yolo_live_screen.dart';
import '../../features/learning/presentation/quiz_screen.dart';
import '../../features/learning/presentation/lesson_detail_screen.dart';
import '../../features/learning/presentation/lesson_quiz_screen.dart';
...
import '../../features/auth/presentation/profile_photo_setup_screen.dart';
...
abstract class AppRoute {
  ...
  static const signYoloLive = '/translator/yolo-live';
...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppRoute.profilePhotoSetup,
        name: 'profilePhotoSetup',
        pageBuilder: (_, __) =>
            const MaterialPage(child: ProfilePhotoSetupScreen()),
      ),
      GoRoute(
        path: AppRoute.serverConfig,
        name: 'serverConfig',
        pageBuilder: (_, __) =>
            const MaterialPage(child: ServerConfigScreen()),
      ),
      ...
      GoRoute(
        path: AppRoute.signYoloLive,
        name: 'sign-yolo-live',
        pageBuilder: (_, __) =>
            const MaterialPage(child: SignYoloLiveScreen()),
      ),
      GoRoute(
        path: AppRoute.quiz,
        name: 'quiz',
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return MaterialPage(child: LessonDetailScreen(lessonId: id));
        },
      ),
      GoRoute(
        path: '/learning/lesson-quiz/:id',
        name: 'lesson-quiz',
        pageBuilder: (context, state) {
          final id = state.pathParameters['id'] ?? '';
          return MaterialPage(child: LessonQuizScreen(lessonId: id));
        },
      ),
      GoRoute(
        path: AppRoute.shop,
