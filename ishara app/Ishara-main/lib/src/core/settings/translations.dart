...
class AppStrings {
  ...
  final String accessibilitySettingsSub;
  final String emergencyContacts;
  final String emergencyContactsSub;
  final String socialLinks;
  final String socialLinksSub;
  final String addPhoto;
  final String addPhotoPrompt;

  // ── Social / Follow Ishara ─────────────────────────────────────────────────
  final String followIshara;
  final String followIsharaSub;
  final String followIsharaTagline;

  // ── Translator circuit breaker ─────────────────────────────────────────────
  final String resetModel;
  final String noContactsSet;
  ...
  const AppStrings({
    ...
    required this.accessibilitySettingsSub,
    required this.emergencyContacts,
    required this.emergencyContactsSub,
    required this.socialLinks,
    required this.socialLinksSub,
    required this.addPhoto,
    required this.addPhotoPrompt,
    required this.followIshara,
    required this.followIsharaSub,
    required this.followIsharaTagline,
    required this.resetModel,
    required this.noContactsSet,
...
const _en = AppStrings(
  ...
  accessibilitySettingsSub: 'TTS, contrast, dyslexia font, motor mode',
  emergencyContacts: 'Emergency Contacts',
  emergencyContactsSub: 'Manage SOS recipients',
  socialLinks: 'Social Links',
  socialLinksSub: 'Instagram, Facebook, Twitter, TikTok…',
  addPhoto: 'Add photo',
  addPhotoPrompt: 'Add a profile photo so others can recognise you.',
  followIshara: 'Follow Ishara',
  followIsharaSub: 'Stay connected with Ishara',
  followIsharaTagline: 'Follow us for updates, tips, and community.',
  resetModel: 'Reset model',
  noContactsSet: 'No emergency contacts set — add one first.',
  addContact: 'Add',
);
...
const _ar = AppStrings(
  ...
  accessibilitySettingsSub: 'قراءة الشاشة، التباين، خط عسر القراءة، وضع الحركة',
  emergencyContacts: 'جهات الطوارئ',
  emergencyContactsSub: 'إدارة مستلمي SOS',
  socialLinks: 'روابط التواصل',
  socialLinksSub: 'إنستغرام، فيسبوك، تويتر، تيك توك…',
  addPhoto: 'إضافة صورة',
  addPhotoPrompt: 'أضف صورة شخصية حتى يتعرف عليك الآخرون.',
  followIshara: 'تابع إيشارا',
  followIsharaSub: 'ابقَ على تواصل مع إيشارا',
  followIsharaTagline: 'تابعنا للحصول على آخر الأخبار والنصائح.',
  resetModel: 'إعادة تهيئة النموذج',
  noContactsSet: 'لا توجد جهات طوارئ — أضف جهة أولاً.',
  addContact: 'إضافة',
);
