  ...
  AuthResult _handleError(DioException e) {
    ...
    if (e.type == DioExceptionType.connectionError ||
      ...
      return AuthResult(
        success: false,
        message:
            'Cannot reach server at $base. On a physical phone, open Server Setup and enter your PC\'s LAN IP (e.g. 192.168.1.25). Make sure the backend is running and your phone is on the same Wi-Fi.',
      );
    }
