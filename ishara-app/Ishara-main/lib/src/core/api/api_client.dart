...
class ApiClient {
  ...
  // Production backend — public Vercel deployment. The app talks to this by
  // default on every platform, so no PC / LAN / Wi-Fi setup is required.
  // Override per-build with --dart-define=API_BASE_URL=<your-url>.
  static const String _fallbackBaseUrl = 'https://ishara-backend.vercel.app';
