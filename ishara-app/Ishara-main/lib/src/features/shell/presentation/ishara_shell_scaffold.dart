...
import '../../../core/services/tap_narrator.dart';
...
class IsharaShellScaffold extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tealColor = isDark ? IsharaColors.tealDark : IsharaColors.tealLight;
    final orangeColor = isDark ? IsharaColors.orangeDark : IsharaColors.orangeLight;
    final navHeight = 68.0 + (bottomInset > 8 ? bottomInset : 12) + 12;
    ...
    return Scaffold(
      ...
      body: TapNarrator(
        ...
        children: [
          ...
          // Floating chatbot bubble — sits above the nav bar on every page
          Positioned(
            right: 18,
            bottom: navHeight,
            child: _ChatbotBubble(teal: tealColor, orange: orangeColor)
                .animate()
                .scale(
...
class _ChatbotBubble extends StatelessWidget {
  const _ChatbotBubble({required this.teal, required this.orange});
  final Color teal;
  final Color orange;
          ...
          child: ScaleTransition(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    _focused
                        ? Border.all(color: teal.withValues(alpha: 0.75), width: 1.5)
                        : null,
              ),
              child: Column(
