...
export function LearningSection({ language }: LearningSectionProps) {
  ...
  const content = {
    en: {
      ...
      wrong: 'Wrong!',
      tryAgain: 'Try Again',
      interactiveSignLanguage: 'Interactive Sign Language',
      learningQuiz: 'Learning Quiz',
      quizDesc: 'Test your knowledge with our interactive quiz!',
    ...
    ar: {
      ...
      interactiveSignLanguage: 'لغة الإشارة التفاعلية',
      learningQuiz: 'اختبار التعلم',
      quizDesc: 'اختبر معلوماتك مع اختبارنا التفاعلي!',
      questionOf: (current: number, total: number) => `سؤال ${current} من ${total}`,
      correctLabel: (n: number) => `${n} صحيح`
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <ScrollReveal direction="left">
            <div className="bg-card p-8 rounded-3xl shadow-2xl">
              <h3 className="mb-6">{t.interactiveSignLanguage}</h3>
                  ...
                  >
                    ...
                    <div className="mb-6">
                      <div className="flex justify-between text-sm text-muted-foreground mb-2">
                        <span>{t.questionOf(currentQuestion + 1, t.questions.length)}</span>
                        <span>{t.correctLabel(score)}</span>
                      </div>
