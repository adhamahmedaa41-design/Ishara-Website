            ...
            <ul className="space-y-3 mb-4">
              {lines.map((l) => (
                <li key={l.product} className="flex items-center gap-3 text-sm">
                  ...
                  <div className="shrink-0 w-12 h-12 rounded-lg overflow-hidden bg-muted border border-border">
                    {resolveImageUrl(l.image) ? (
                      <img
                        src={resolveImageUrl(l.image)}
                        alt={language === 'ar' ? l.titleAr || l.titleEn : l.titleEn}
